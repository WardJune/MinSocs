<template>
  <div class="px-3 bg-dark text-light">
    <div class="row">
      ...
      >
        <div class="top">
          <a href="#" class="navbar-brand link-light fw-bold">MinSocs</a>
          <ul class="nav flex-column fs-5 mt-2 font-weight-light">
            ...
            <li class="nav-item">
              <a class="nav-link link-light" href="{{ route('notif') }}"
                ><i class="fas fa-bell"></i>
                <span class="menu-text">Notifications</span></a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link link-light" href="{{ route('friends') }}"
                ><i class="fas fa-user-friends"></i>
                <span class="menu-text">Friends</span></a
              >
            </li>
            <li class="nav-item">
        ...
        <div class="user d-flex justify-content-between mb-3">
          ...
          <ul class="navbar-nav">
            <li class="nav-item dropup">
              <a
                class="nav-link link-warning dropdown-toggle"
                id="dropup"
                role="button"
      ...
      <div class="sticky-top vh-100 col-md-3 pt-3">
        ...
        <div class="border rounded-3 mx-2 p-3">
          ...
          <div class="profile-1 d-flex justify-content-between mb-2">
            ...
            <button class="btn rounded-pill btn-sm btn-outline-warning">
              Add Friend
            </button>
          </div>
          <div class="profile-1 d-flex justify-content-between mb-2">
